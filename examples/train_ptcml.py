...
from ptcml.trainers import PTCMLTrainer
...
def main_worker(args):
    ...
    for epoch in range(args.epochs):
        ...
        # training
        trainer = PTCMLTrainer(model, rts_score, num_class=num_class, num_part=num_part, beta=args.beta,
                              tmcls_epoch=args.tmcls_epoch)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="PTCML: Patch-based Tendency Camera Multi-Constraint Learning")
    # data
